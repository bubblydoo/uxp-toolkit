...
const createUxpManifest: (opts: CreateManifestOpts) => UxpManifest = ({
  ...
  return {
    ...
    icons: [
      { width: 48, height: 48, path: 'icons/plugin-dark.png', scale: [1, 2], theme: ['darkest', 'dark'], species: ['pluginList'] },
      { width: 48, height: 48, path: 'icons/plugin-light.png', scale: [1, 2], theme: ['lightest', 'light', 'all'], species: ['pluginList'] },
    ],
  };
};
